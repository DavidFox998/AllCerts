...
**Current wall: 485 BRICKS** (script-reported by `scripts/check-towers.sh`).
Last verified build: `towers-build` workflow, 2026-05-28 (Batch 162 /
TRI PARALLEL #2) — 485 brick(s) passed the axiom-footprint check.
