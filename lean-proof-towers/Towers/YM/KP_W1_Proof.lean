...
private lemma r_kp_pos : 0 < r_kp := by unfold r_kp; positivity
...
private lemma g_kp_nonneg (k : ℤ) : 0 ≤ g_kp k := by unfold g_kp; positivity
...
private lemma tsum_kp_det_split :
  ...
  (Finset.sum_add_tsum_compl S26kp summable_toeplitz_det_kp).symm
